...
const unsigned int Max_Head = 10000; /* the memory model heap max size */
const unsigned int wsize = 4; /* word and header/footer size bytes*/
const unsigned int dsize = 8; /* double word size bytes*/
